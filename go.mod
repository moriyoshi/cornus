...
// Pinned by github.com/moriyoshi/sable (reached through imbh-go, the `imbh`
// build tag): the fused Rust/Go runtime reaches Go's internal ABI via
// //go:linkname, so it is only valid against this exact toolchain.
toolchain go1.26.4
...
require (
	...
	github.com/moriyoshi/imbh-go v0.3.0
...
require (
	...
	github.com/moriyoshi/sable v0.0.0-20260726045720-0c6fe56eb099 // indirect
