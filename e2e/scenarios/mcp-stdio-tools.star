...
if TARGET == "local":
    ...
    assert_eq(workloads["is_error"], False, "workloads_list")
    ...
    assert_eq(detail["is_error"], False, "workload_get")
    ...
    assert_eq(graph["is_error"], False, "project_graph")
    ...
    assert_eq(logs["is_error"], False, "logs_tail")
    if TARGET == "incus":
    ...
    assert_eq(executed["is_error"], False, "exec_run")
    ...
    assert_eq(files["is_error"], False, "files_list")
    compose_path = ""
    ...
    assert_eq(read["is_error"], False, "file_read")
