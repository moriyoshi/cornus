...
assert_true(not activity["is_error"], "activity resource read errored: %s" % activity["text"])
...
assert_true(not again["is_error"], "session did not survive a tool error: %s" % again["text"])
