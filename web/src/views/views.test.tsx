...
describe("Settings", () => {
  ...
  it("renders its groups as ordinary sections, not cards", () => {
    ...
    // Every setting is the same row, whatever control it carries: six checkboxes, four
    // selects (new-pane placement, new-pane sizing, chooser gutter side, prefix combination),
    // and the shell-candidates textarea. (This screen has been down to one group and back up to
    // two, so the uniform-row rule is what has to survive the churn — hence the shape asserted
    // per row rather than a count alone.)
