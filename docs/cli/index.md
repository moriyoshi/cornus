...
| [`cornus ingress-tunnel`](/cli/ingress-tunnel) | Publish a deployment or Compose project's declared ingress through one public tunnel. |
| [`cornus config`](/cli/config) | Manage connection profiles (contexts) for reaching a remote cornus server. |
| [`cornus setup`](/cli/setup) | Interactively configure and verify a server connection. |
| [`cornus auth`](/cli/auth) | Enroll and manage SSH public keys for short-lived client sessions. |
| [`cornus compose`](/cli/compose) | Docker Compose-compatible client for Compose / devcontainer projects. |
| [`cornus web`](/cli/web) | Serve the browser UI and client-side BFF (loopback by default). |
...
| [`cornus activity`](/cli/activity) | Read the server activity flight record. |
| [`cornus storage`](/cli/storage) | Inspect and migrate registry storage. |
| [`cornus observe`](/cli/observe) | Query stored workload logs, traces, and metrics. |
