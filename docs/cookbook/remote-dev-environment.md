...
- [Client-local bind mounts over 9P](/topics/remote-workflows) — your source lives on the laptop, streamed on demand into the remote workload.
...
**See also:** [remote workflows](/topics/remote-workflows) · [remote clusters](/guides/remote-clusters) · [Compose, devcontainers, and the docker CLI](/guides/compose-devcontainers-docker) · [connection config](/reference/connection-config) · [Cookbook](/cookbook/)
