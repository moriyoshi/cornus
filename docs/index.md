...
features:
  ...
  - icon: 🚀
    ...
    details: >-
      A pluggable deploy backend — dockerhost, native containerd, daemonless bare,
      Incus application containers, and client-go Kubernetes — behind one interface, with
      client-local bind mounts, port forwarding, egress control, and a
      workload-to-workload hub overlay.
