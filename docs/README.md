...
- `guides/` — per-feature how-tos (building, deploying, networking, security, output modes, ...).
...
- `topics/` — cross-cutting concepts (remote workflows, tunnels/hub, egress/credentials, auth/TLS).
