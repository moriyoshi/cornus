...
model; [auth and TLS](/topics/auth-and-tls) covers setup, and the
[security guide](/guides/security) covers hardening recipes.
...
- [Auth & TLS](/topics/auth-and-tls) — configuring every verifier and TLS mode.
- [Security guide](/guides/security) — hardening recipes.
