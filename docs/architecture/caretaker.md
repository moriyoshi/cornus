...
See [egress](/guides/egress) for modes, routes, and PAC usage; what
...
- [Deploying workloads](/guides/deploying-workloads) — mounts and sessions in
  practice.
- [Egress](/guides/egress) — modes, routes, and PAC policy in practice.
- [Credentials](/guides/credentials) — source backends and delivery kinds.
