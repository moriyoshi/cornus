...
- 从 runner 经 9P 驱动的进程内 build engine——见[构建镜像](/zh/guides/building-images)。
...
**另请参阅:** [Cookbook](/zh/cookbook/) · [构建镜像](/zh/guides/building-images) · [部署工作负载](/zh/guides/deploying-workloads) · [镜像仓库和存储](/zh/guides/registry) · [使用远程集群](/zh/guides/remote-clusters) · [部署后端](/zh/reference/deploy-backends)
