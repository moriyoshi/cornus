...
| [`cornus ingress-tunnel`](/zh/cli/ingress-tunnel) | 通过一个公共 tunnel 发布部署或 Compose 项目声明的 ingress。 |
| [`cornus config`](/zh/cli/config) | 管理访问远程 cornus 服务器的连接配置文件 (context) 。 |
| [`cornus setup`](/zh/cli/setup) | 以交互方式配置并验证服务器连接。 |
| [`cornus auth`](/zh/cli/auth) | 注册并管理用于短期客户端会话的 SSH 公钥。 |
| [`cornus compose`](/zh/cli/compose) | 面向 Compose / devcontainer 项目的 Docker Compose 兼容客户端。 |
| [`cornus web`](/zh/cli/web) | 提供浏览器 UI 和客户端侧 BFF (默认仅限 loopback) 。 |
| [`cornus daemon`](/zh/cli/daemon) | Docker API frontend 和统一后台 agent 控制。 |
| [`cornus hub`](/zh/cli/hub) | 作为 spoke 加入工作负载到工作负载的覆盖网络。 |
| [`cornus activity`](/zh/cli/activity) | 读取服务器 activity 飞行记录。 |
| [`cornus storage`](/zh/cli/storage) | 检查并迁移注册表存储。 |
| [`cornus observe`](/zh/cli/observe) | 查询已存储的工作负载日志、追踪和指标。 |
