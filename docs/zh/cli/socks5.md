...
这是由 `cornus config set-context --conduit-mode socks5` 选择的每 session conduit mode 的临时对应方式。它以 profile 的 SOCKS5 设置为起点，再应用显式 flag override。SOCKS5 conduit 与 port-forward 和其他工作负载访问方式的关系，请参见[远程工作流](/zh/topics/remote-workflows)。
