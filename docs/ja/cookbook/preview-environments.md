...
- [トンネル](/ja/guides/tunnels) — 共有可能な URL の基になるモデルです。
...
# 例: https://abcd-1234.ngrok-free.app を表示。PR に貼り付ける
```
...
cornus deploy -f preview.yaml --detach
# レビュー担当者は https://app-pr-123.preview.example.com を開く
```
...
**関連項目:** [イメージをビルドする](/ja/guides/building-images) · [ワークロードをデプロイする](/ja/guides/deploying-workloads) · [ネットワークと conduit](/ja/guides/networking) · [トンネル](/ja/guides/tunnels) · [クックブック](/ja/cookbook/)
