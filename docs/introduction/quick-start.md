...
See [connection config](/reference/connection-config) and [remote workflows](/topics/remote-workflows) for connecting to a remote or ingress-less cluster.
...
* [Remote workflows](/topics/remote-workflows) — point the CLI at a remote cluster.
* [Tunnels](/guides/tunnels) — expose a workload publicly.
* [The workload hub](/topics/hub) — reach other workloads by name.
