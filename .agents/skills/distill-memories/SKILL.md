...
- `docs/guides/` ... per-feature how-tos (building, deploying, networking, egress, credentials, registry, security, observability, output modes, compose/devcontainers).
...
- `docs/topics/` ... cross-cutting concepts (remote workflows, tunnels/hub, client-side egress, credential brokering, auth/TLS).
