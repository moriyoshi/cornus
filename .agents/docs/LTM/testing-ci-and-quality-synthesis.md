...
- `.agents/docs/TESTING.md` — the how-to-use harness reference (builtins, targets, preflight, dind
  runner). `.agents/docs/AUDIT_2026-07.md` — the finding-by-finding audit report.
...
- **Audit severities in `AUDIT_2026-07.md` are verifier-corrected**, not the reviewers' originals —
