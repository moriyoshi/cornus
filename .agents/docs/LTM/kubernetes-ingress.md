...
direct deploy spec's camelCase spellings. Background-agent conduit configuration
remains first-writer per project and needs explicit reconciliation when changed.
