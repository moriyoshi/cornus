...
- `.agents/docs/AUDIT_2026-07.md` — canonical finding-by-finding report for all 73 confirmed findings (do not duplicate here).
...
- Severities in `AUDIT_2026-07.md` are verifier-corrected, not the original reviewer ratings — do not re-derive severity from a reviewer's wording.
