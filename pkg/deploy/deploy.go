...
//   - bare and incus, which return a flat false: they set Remote() for the
//     sidecar-mount path but run no companion carrying a caretaker AgentRelayRole,
//     so the Remote()-based inference would wrongly grant the feature.
//
