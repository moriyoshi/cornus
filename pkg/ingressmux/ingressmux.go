...
// The idle-bridge bound now lives in ingressroute.IdleBridgeTimeout, shared with
// the client-side emulation (pkg/ingressemu) so the two cannot drift apart again.
...
func NewProxy(t *Table, d portfwd.Dialer) *Proxy {
	...
	p.proxy = &httputil.ReverseProxy{
		...
		// See ingressroute.BridgeTransport, shared with the client-side emulation.
